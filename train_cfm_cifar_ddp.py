...
from data_loader import UnlabeledImageDataset
...
flags.DEFINE_string("output_dir", "./results_flickr_exp2/", help="output_directory")
# UNet
...
def main(argv):
    ...
    total_num_gpus = int(os.getenv("WORLD_SIZE", 2))
